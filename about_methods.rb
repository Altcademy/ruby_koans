...
class AboutMethods < Neo::Koan
  ...
  def test_method_without_explicit_return
    ...
    # Explanation:
    # In Ruby, if the keyword `return` is not define, a Ruby function will, by default, return the last statement in the function.
  end
  ...
  def test_calling_methods_in_same_class_with_explicit_receiver
    ...
    # Explanation:
    # We are going to talk about what `self` do later.
  end
